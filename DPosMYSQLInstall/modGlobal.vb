...
'modUpgradeDatabase - to apply database updates on MSSERVER 
...
#Region "DeliverITSQL Tables"
        ...
        arDPOSTables.Add("deliveritsql" & CHAR_PARA & "tblSubCategory" & CHAR_PARA & "(`SubCategoryID` int(11) NOT NULL AUTO_INCREMENT, `CategoryID` int(11) DEFAULT NULL, `Description` varchar(255) DEFAULT NULL, `Active` smallint(1) DEFAULT NULL, `Exclude` smallint(1) DEFAULT NULL, `PrintPriority` int(11) DEFAULT NULL, `DisableHalfHalf` smallint(1) DEFAULT NULL, `BackColour` varchar(20) DEFAULT NULL, `HighlightAdditionalItems` smallint(1) DEFAULT NULL, `ExcludeFromDiscount` smallint(1) DEFAULT NULL, `ExcludeFromRepeat` smallint(1) DEFAULT NULL, `EnablePercent` smallint(1) DEFAULT NULL, `Discount` double DEFAULT NULL, `DisplayPriority` int(11) DEFAULT NULL, `ExtrasColour` varchar(50) DEFAULT NULL, `HalfHalfFee` decimal(10,2) DEFAULT NULL, PRIMARY KEY (`SubCategoryID`)) ENGINE=InnoDB DEFAULT CHARSET=utf8")
        ...
        Select Case sTableName
            ...
            Case "tblOrderHeaders"
                sReturn.Append("OrderID,TakenBy,OrderDate,DeliveredBy,LocationID,TenderedAmt,Comments,TransactionStatus,CustomerID,PickupTime,TransactionType,CustomerName," _
                                    ...
                                    & "PosReferenceID,MakeStartTime,ServiceFee")
            ...
            Case "tblSubCategory"
                sReturn.Append("SubCategoryID,CategoryID,Description,Active,Exclude,PrintPriority,DisableHalfHalf,BackColour,HighlightAdditionalItems,ExcludeFromDiscount,ExcludeFromRepeat,EnablePercent,Discount,DisplayPriority,ExtrasColour,HalfHalfFee")
        ...
        Try
            Select Case sTablename
                ...
                Case "tblOrderHeaders"
                    ...
                    sScript &= "char(34) + PosReferenceID + char(34), char(34) + MakeStartTime + char(34), char(34) + CONVERT(varchar(20), ISNULL(ServiceFee,0)) + char(34) "
                ...
                Case "tblSubCategory"
                    ...
                    sScript &= "ISNULL(DisplayPriority,0), char(34) + ExtrasColour + char(34), char(34) + CONVERT(varchar(20), ISNULL(HalfHalfFee,0.00)) + char(34) FROM [DeliveritSQL].[dbo].[tblSubCategory]"" queryout " & sDestination & sFileName & " -c -T -t"",""'"
                Case "tblSubCategoryPrinters"
