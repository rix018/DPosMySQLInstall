        ...
        Select Case sTableName
            ...
            Case "tblArticles"
                sReturn.Append("ArticleID,Description,PLU,SellShop,SellDelivery,SellTable,SellCost,HideDelivery,HidePickup,HideTable,CategoryID,SubCategoryID," _
                    ...
                    & "Topping8,Topping9,Topping10,Topping11,Topping12,Topping13,Topping14,Topping15,PrintZeroAmt,StickerPrint,UpsellItem,ExcludeCondimentCharge")
            Case "tblAudit"
        ...
        Try
            Select Case sTablename
                ...
                Case "tblArticles"
                    ...
                    sScript &= "char(34) + Topping14 + char(34), char(34) + Topping15 + char(34), char(34) + CONVERT(varchar(10), ISNULL(PrintZeroAmt,0)) + char(34), char(34) + StickerPrint + char(34), ISNULL(UpsellItem, 0), ISNULL(ExcludeCondimentCharge, 0) "
